...
Core Stripe checkout, webhook idempotency, subscription persistence, entitlement counts, and lapse behavior were pulled forward and completed in `TASK-0040`. Phase 6 therefore focuses on reconciling the remaining launch-readiness gaps: real Lovable checkout testing, subscription management/cancellation behavior, free-tier paid share-link policy, entitlement/lapse ops visibility, and QA closure.
...
| 6.3 | TASK-0062 | Resolve Free-Tier Paid Share-Link Entitlement Policy | Claude / Codex | Spec Drafted - Awaiting David Approval | TASK-0056, TASK-0040 |
...
- Phase 5 share-link behavior is clear enough to evaluate free-tier paid action policy.
...
- Free-tier share-link paid action policy is resolved and either implemented or explicitly deferred by David.
