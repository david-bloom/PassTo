...
| TASK-0074 | Implement Isolated Demo/UAT Platform for TASK-0073. | Approved for Execution 2026-06-16 - Stage 1 Engineering Validation (APPROVAL-0037) | Stands up the isolated demo/UAT Supabase project (`atnmcjkjshyqcttnmzkq`), schema/RLS/storage, Edge Functions, identity and license simulators, selfie short-TTL delivery contract, demo Apple/Google wallet configuration, Lovable demo/UAT frontend, automatic participant-phone cleanup, source reconciliation, and the pre-cohort-1 gates inherited from TASK-0073. Codex CR-0074, CR2-0074, CR3-0074, and CR4-0074 dispositioned in commits 302b150/53f7be7/9fc61cd/be5a22d. Execution approved under APPROVAL-0037; Stage A and Stage B cohort gates remain in force. Target: Stage B first moderated nurse cohort by 2026-07-01. |
