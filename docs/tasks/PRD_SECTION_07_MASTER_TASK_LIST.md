...
| TASK-0074 | Implement Isolated Demo/UAT Platform for TASK-0073. | Spec Drafted - Awaiting David Execution Approval | Stands up the isolated demo/UAT Supabase project (`atnmcjkjshyqcttnmzkq`), schema/RLS/storage, Edge Functions, identity and license simulators, selfie short-TTL delivery contract, demo Apple/Google wallet configuration, Lovable demo/UAT frontend, automatic participant-phone cleanup, source reconciliation, and the pre-cohort-1 gates inherited from TASK-0073. Target: Stage B first moderated nurse cohort by 2026-07-01. Execution gated on a separate David approval; APPROVAL-0036 authorizes creation only. |
