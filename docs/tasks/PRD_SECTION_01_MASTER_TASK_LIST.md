...
| TASK-0012 | Write v4 migration SQL for `wvzjfxacykgsaffskgtr`. | Done — 2026-05-26 | Claude | 15 tables, full RLS, indexes, 37 seed rows, SECURITY DEFINER RPCs. Deliverable: `V4_MIGRATION_SQL.md` (SHA `9baff755`). Blocks TASK-0013. |
...
| TASK-0015 | Post-migration schema and RLS verification. | Done — 2026-05-26 | Claude | All checks passed. 2 remediation migrations applied (R1+R2). Deliverable: `V4_MIGRATION_VERIFICATION.md` (SHA `b5d1c67f`). |
